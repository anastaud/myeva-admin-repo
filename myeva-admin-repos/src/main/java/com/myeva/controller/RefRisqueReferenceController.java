...
@Controller
@RequestMapping("/private/refrisquereferences")
public class RefRisqueReferenceController { 

	private static final Logger LOGGER = LoggerFactory.getLogger(RefRisqueReferenceController.class);
